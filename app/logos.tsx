...
const brands: Brand[] = [
  { name: 'Apple', logo: 'https://images.pexels.com/photos/788946/pexels-photo-788946.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop' },
  { name: 'Google', logo: 'https://images.pexels.com/photos/2041627/pexels-photo-2041627.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop' },
  ...
  { name: 'Meta', logo: 'https://images.pexels.com/photos/267350/pexels-photo-267350.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop' },
...
function BrandLogo({ brand }: { brand: Brand }) {
  return (
    <div className="flex-shrink-0 mx-6 group cursor-pointer">
      <div className="relative overflow-hidden rounded-2xl bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-yellow-100 p-4">
        <img 
          src={brand.logo}
          alt={brand.name}
        ...
        <span className="absolute bottom-2 left-2 right-2 text-xs font-medium text-white bg-black/50 backdrop-blur-sm rounded-lg px-2 py-1 text-center">
          {brand.name}
        </span>
      </div>
    </div>
